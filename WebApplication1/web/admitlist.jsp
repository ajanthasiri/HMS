...
<style>
      ...
      .tableFixHead thead th {
        ...
        <title>Admitted Patients List Page</title>
         <meta charset="utf-8">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <form method="post" action="admitedit" id="f1">
            <input id="id" type="hidden" placeholder="Enter Patient ID" class="form-control" name="id">
                   
            <input id="patid" type="text" placeholder="Enter Patient ID" class="form-control" name="patid">

            <input id="patname" type="text" placeholder="Enter Patient Name" class="form-control" name="patname">

            <input id="docid" type="text" placeholder="Enter Doctor ID" class="form-control" name="docid">

            <input id="docname" type="text" placeholder="Enter Doctor Name" class="form-control" name="docname">

            <input id="wardno" type="text" placeholder="Enter Ward No." class="form-control" name="wardno">

          <input id="bedno" type="text" placeholder="Enter Bed No." class="form-control" name="bedno">

          <input id="addate" type="date" placeholder="Enter Admitted Date" class="form-control" name="addate">
    ...
    <!-- ################# Our Team Starts Here#######################--->
      ...
      <!--  ************************* Page Title Starts Here ************************** -->
               <div class="page-nav no-margin row">
                   <div class="container">
                       <div class="row">
                           <h2 style="color:white;">Admitted Patients</h2>
                           ...
                           <table class="table" border="1" style="background-color:rgba(255,255,255,0.8);">
                               <thead>
                                   <tr>
                                    ...
                                    <th style="background-color:white;">Ward No.</th>
                                    <th style="background-color:white;">Bed No.</th>
                                    <th style="background-color:white;">Admitted Date</th>
                              ...
                              <%
                                ...
                                String sql ="select * from patadmit";
                                ...
                                <td><%=resultSet.getString("bedno") %></td>
                                <td><%=resultSet.getString("addate") %></td>
                                <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" onclick="document.getElementById('id').value='<%=resultSet.getString("id") %>';document.getElementById('patid').value='<%=resultSet.getString("patid") %>';document.getElementById('patname').value='<%=resultSet.getString("patname") %>';document.getElementById('docid').value='<%=resultSet.getString("docid") %>';document.getElementById('docname').value='<%=resultSet.getString("docname") %>';document.getElementById('wardno').value='<%=resultSet.getString("wardno") %>';document.getElementById('bedno').value='<%=resultSet.getString("bedno") %>';document.getElementById('addate').value='<%=resultSet.getString("addate") %>';">
                                    Edit
                                  </button></td>
                                <td><form id="f2" action="admitdlt" method="post"> <input type="hidden" name="id" value="<%=resultSet.getString("id") %>"> <input class="btn btn-success btn-appointment" type="submit" value="Delete"> </form></td>
                                </tr>
                                <%
                                }
                                connection.close();
