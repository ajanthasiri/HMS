...
<html lang="en">
    <head>
        ...
        <title> Admit Patient Page</title>
                   ...
                   <div class="container">
                       <div class="row">
                           ...
                           <%  String m1="";
                            ...
                            <%   if(m1.equals("Patient admitted successfully")){ %>
            ...
            <div class="about-us" style="background-color:rgba(255,255,255,0.7);">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                    <form method="post" action="patadmit">
                    <div class="form-data">
                        <div class="form-head">
                            <h2> ADMIT PATIENT </h2>
                        </div>
                        <div class="form-body">
                            ...
                            <div class="row form-row">
                             ...
                             <div class="row form-row">
                              <input type="text" placeholder="Enter Ward No." class="form-control" name="wardno" required="required">
                            </div>
                            <div class="row form-row">
                              <input type="text" placeholder="Enter Bed No." class="form-control" name="bedno" required="required">
                            </div>
                             <div class="row form-row">
                                <div class="col-sm-12">
                                    <label>Enter Admitted Date:</label><input type="date" placeholder="Admitted Date" class="form-control" name="date" required="required">
                                </div>
                             <div class="row form-row">
