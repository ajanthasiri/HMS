 ...
 * @author AJANTHA
 */
@WebServlet(name = "patadmit", urlPatterns = {"/patadmit"})
public class patadmit extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                String query="insert into patadmit(patid,patname,docid,docname,wardno,bedno,addate) value(?,?,?,?,?,?,?)";
                ...
                pst.setString(7,request.getParameter("date"));
                pst.execute();
            }
            catch(Exception e){
                e.printStackTrace();
            ...
            response.sendRedirect("http://localhost:8080/WebApplication1/patadmit.jsp?msg=Patient admitted successfully");
        }
    }
