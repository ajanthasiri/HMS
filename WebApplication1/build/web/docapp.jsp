               ...
               <div class="page-nav no-margin row">
                   <div class="container">
                       <div class="row">
                           ...
                           <table class="table" id="myTable" border="1" style="background-color:rgba(255,255,255,0.8);">
                               <thead>
                                   <tr>
                              ...
                              <%
                                ...
                                String sql ="select * from appointments where docid='"+request.getParameter("msg")+"'";
